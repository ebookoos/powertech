(function () {
    ...
    !function (e, t) {
        ...
        }, n[y].settings = {resizeThrottle: 100, scrollThrottle: 30}, i.on("load.waypoints", function () {
            return n[y]("refresh")
        })
    })
}).call(this), function () {
    ...
    var c, u, f = {}, d = t.documentElement, h = t.createElement("modernizr"), p = h.style, m = "Webkit Moz O ms",
        g = m.split(" "), v = m.toLowerCase().split(" "), w = {}, y = [], $ = y.slice, C = {}.hasOwnProperty;
    u = i(C, "undefined") || i(C.call, "undefined") ? function (e, t) {
        ...
        var n = $.call(arguments, 1), o = function () {
            if (this instanceof o) {
                var i = function () {
                };
                i.prototype = t.prototype;
                var r = new i, a = t.apply(r, n.concat($.call(arguments)));
    ...
    return f.addTest = function (e, t) {
        if ("object" == typeof e)for (var o in e)u(e, o) && f.addTest(o, e[o]); else {
            if (e = e.toLowerCase(), f[e] !== n)return f;
            t = "function" == typeof t ? t() : t, d.className += " " + (t ? "" : "no-") + e, f[e] = t
        }
        return f
    }, o(""), h = null, function (e, t) {
        function n(e, t) {
        ...
        var c, u, f = e.html5 || {}, d = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,
    ...
    function s(e, n, o, i, r, s, c) {
        ...
        var c = c || d.errorTimeout, f = t.createElement(e), h = 0, g = 0, y = {t: o, s: n, e: r, a: s, x: c};
    ...
    var f, d, h = t.documentElement, p = e.setTimeout, m = t.getElementsByTagName("script")[0], g = {}.toString, v = [],
        w = 0, y = "MozAppearance" in h.style, $ = y && !!t.createRange().compareNode, C = $ ? h : m.parentNode,
        h = e.opera && "[object Opera]" == g.call(e.opera), h = !!t.attachEvent && !h,
        b = y ? "object" : h ? "script" : "img", S = h ? "script" : b, x = Array.isArray || function (e) {
    ...
    d = function (e) {
        function t(e) {
            var t, n, o, e = e.split("!"), i = k.length, r = e.pop(), a = e.length,
        ...
        function l(e, t) {
            function n(e, n) {
                if (e) {
                    if (i(e)) n || (f = function () {
                        ...
                        d.apply(this, e), h()
                    }), a(e, f, t, 0, c); else if (Object(e) === e)for (s in l = function () {
                        var t, n = 0;
            ...
            var l, s, c = !!e.test, u = e.load || e.both, f = e.callback || r, d = f, h = e.complete || r;
            n(c ? e.yep : e.nope, !!u), u && n(u)
        }

        var s, c, f = this.yepnope.loader;
        if (i(e)) a(e, 0, f, 0); else if (x(e))for (s = 0; s < e.length; s++)c = e[s], i(c) ? a(c, 0, f, 0) : x(c) ? d(c) : Object(c) === c && l(c, f); else Object(e) === e && l(e, f)
        ...
        var u, f, h = t.createElement("script"), i = i || d.errorTimeout;
        h.src = e;
        ...
        var c, i = t.createElement("link"), n = s ? l : n || r;
...
(namespace = function (e, t, n) {
    ...
    e.navSwap = function (e) {
        ...
        $(document).ready(function () {
            ...
            }, t = !1, n = $(window).height(), o = $(document).scrollTop(), i = $("#home-our-work").offset().top;
        ...
        $("[data-toggle]").on("click", function (e) {
            e.preventDefault();
            var t = $(this), n = t.data("toggle"), o = $(n), i = $("[data-toggle=" + n + "]");
        ...
        $(document).ready(function () {
            var e = function () {
                    return $(window).width() > 960
                }, t = !1, n = $(window).height(), o = $(document).scrollTop(),
        ...
        $(document).ready(function () {
            ...
            }, {offset: "70%"}), $(".carl-letter-section").waypoint(function () {
